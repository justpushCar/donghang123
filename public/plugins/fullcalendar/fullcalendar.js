...
TimeGrid.mixin({
	...
	eventSkeletonEl: null, // has cells with event-regions, which contain absolutely positioned event elements
...
fcViews.agenda = View.extend({ // AgendaView
	...
	// Builds the HTML skeleton for the view.
	// The day-grid and time-grid components will render inside regions defined by this HTML.
	renderHtml: function() {
		return '' +
			'<table>' +
				'<thead>' +
